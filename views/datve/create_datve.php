...
// Lấy danh sách vé máy bay còn trống
$veMayBay = getVeMayBayByStatus('Còn trống');
?>
...
<head>
    ...
    <title>Thêm Đặt vé - Airline Management System</title>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">
                            <i class="fas fa-calendar-plus"></i> Thêm Đặt vé mới
                        </h5>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="../../handle/datve_process.php">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" id="mave" name="mave" required>
                                        ...
                                        <?php foreach ($veMayBay as $ve): ?>
                                            <option value="<?= $ve['MaVe'] ?>" data-price="<?= $ve['GiaVe'] ?>">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <small class="form-text text-muted">Tổng tiền sẽ được tính tự động khi chọn vé</small>
                                </div>
                                <div class="col-md-6 mb-3">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save"></i> Lưu đặt vé
                                </button>
                            </div>
                        </form>
                    </div>
